    ...
    <nav className="fixed top-0 left-0 right-0 z-10  bg-[#ffffff0a] bg-[#000000] border border-black rounded-full shadow-lg px-2 py-3 mx-20 mt-10 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        <div className="flex md:order-2">
          <button
            type="button"
            className="text-primary bg-[#D9D9D9C9] hover:bg-[#d9d9d9df] focus:ring-4 focus:outline-none  font-bold font-inter rounded-full text-sm px-4 py-2 text-center mr-3 md:mr-0 "
          >
            Launch App
          </button>
          <button
